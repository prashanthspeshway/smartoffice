...
<div class="main-container">
   <div class="sidebar">
    <button class="sidebar-btn active" onclick="setActive(this); showSection('selfAttendance')">
        <i class="fa-solid fa-user-check"></i>
        <span>My Attendance</span>
    </button>

    <button class="sidebar-btn" onclick="setActive(this); showSection('teamSection')">
        <i class="fa-solid fa-users"></i>
        <span>My Team</span>
    </button>

    <button class="sidebar-btn" onclick="setActive(this); showSection('assignTask')">
        <i class="fa-solid fa-list-check"></i>
        <span>Assign Tasks</span>
    </button>

    <button class="sidebar-btn" onclick="setActive(this); showSection('schedulemeeting')">
        <i class="fa-solid fa-handshake"></i>
        <span>Schedule Meetings</span>
    </button>

    <button class="sidebar-btn" onclick="setActive(this); showSection('attendance')">
        <i class="fa-solid fa-clipboard-user"></i>
        <span>Team Attendance</span>
    </button>

    <button class="sidebar-btn" onclick="setActive(this); location.href='<%=request.getContextPath()%>/manager?tab=leave'">
        <i class="fa-solid fa-calendar-xmark"></i>
        <span>Leave Requests</span>
    </button>

    <button class="sidebar-btn" onclick="setActive(this); showSection('performance')">
...
<div class="box" id="selfAttendance" style="display: none;">
    ...
    <fieldset class="attendance-fieldset">
        ...
        <div class="attendance-row">
            ...
            <span class="value"><%= punchIn != null ? punchIn : "--" %></span>
        </div>

        <div class="attendance-row">
            <span class="label">Punch Out</span>
            <span class="value"><%= punchOut != null ? punchOut : "--" %></span>
        </div>

        <div class="attendance-buttons">
            <form action="attendance" method="post">
                <input type="hidden" name="action" value="punchin">
                <button class="primary-btn" <%= punchIn != null ? "disabled" : "" %>>
                    Punch In
                </button>
            </form>
            ...
            <form id="performanceForm"
                ...
                <div class="radio-group">
                    <label><input type="radio" name="rating"
                        value="EXCELLENCE" required> Excellence</label> 
                    <label><input
                        type="radio" name="rating" value="GOOD"> Good</label> 
                    <label><input
                        type="radio" name="rating" value="AVERAGE"> Average</label> 
                    <label><input
        ...
        <div class="team-scroll">
            <div class="employee-grid">
                ...
                <div class="employee-card">
                    ...
                    <div class="emp-body">
                        <div><b>Username:</b> <%=u.getUsername()%></div>
