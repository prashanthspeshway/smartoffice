...
.page-title{font-family:'Fraunces',Georgia,serif;font-size:26px;font-weight:600;color:var(--text);display:flex;align-items:center;gap:10px}
...
.stat-num{font-size:28px;font-weight:700;line-height:1;color:var(--text)}
...
.chart-card{background:var(--surface);border:1px solid var(--border);border-radius:var(--radius);padding:20px;box-shadow:var(--shadow-sm);animation:fadeUp .5s ease both}
...
.insight-card{background:var(--surface);border:1px solid var(--border);border-radius:var(--radius);padding:16px;box-shadow:var(--shadow-sm);display:flex;align-items:center;gap:12px}
...
var trendLabels = [];
var trendData   = [<%= attr(request,"attendanceTrend","72,75,80,78,82,85,83,87,84,88,86,90,89,91,88,85,87,90,92,89,91,94,92,88,90,93,91,89,87,90") %>];
