 ...
 * Call NotificationService.notify(...) from any servlet to send a notification.
 *
 * Usage examples:
 *   NotificationService.notify(employeeEmail, adminEmail, "TASK",   "New task assigned: Fix login bug");
 *   NotificationService.notify(managerEmail,  adminEmail, "LEAVE",  "Employee John applied for leave");
 *   NotificationService.notifyMany(emails,    adminEmail, "MEETING","Meeting scheduled: Sprint Review on Mon 10AM");
 */
public class NotificationService {
    ...
    // ─────────────────────────────────────────────────────────────
    // Send to MULTIPLE recipients at once (e.g. meeting participants)
    // ─────────────────────────────────────────────────────────────
    public static void notifyMany(List<String> recipientEmails, String createdBy, String type, String message) {
        ...
        try (Connection con = DBConnectionUtil.getConnection();
            ...
            for (String email : recipientEmails) {
                ...
                if (email.trim().equalsIgnoreCase(createdBy)) continue;
    ...
    // ─────────────────────────────────────────────────────────────
    // Notify ALL managers (helper used when employee does something)
    // ─────────────────────────────────────────────────────────────
    ...
    // ─────────────────────────────────────────────────────────────
    // Notify the direct manager of an employee
    // ─────────────────────────────────────────────────────────────
    ...
    // ─────────────────────────────────────────────────────────────
    // Get unread count for badge (used by NotificationCountServlet)
    // ─────────────────────────────────────────────────────────────
