...
public class AdminDAO {
	...
	/**
	 * Monthly attendance rate (%). Formula: (total punch-ins this month) / (total
	 * staff × distinct working days so far) × 100
	 */
	...
	/**
	 * Tasks completed this month. Uses submitted_at (the column that exists in your
	 * tasks table). Status value 'COMPLETED' matches your tasks.status default
	 * pattern.
	 */
	...
	/**
	 * Leave requests with status = 'PENDING'. Matches your leave_requests.status
	 * default value.
	 */
	...
	/**
	 * Total teams — your teams table has no status column, so every row counts as
	 * an active team.
	 */
	...
	/**
	 * Punch-in time buckets for the current week. Returns 5 comma-separated values:
	...
	// 'ASSIGNED', 'COMPLETED', 'DOCUMENT_VERIFICATION', 'ERRORS_RAISED'
	// =========================================================================
	...
	/**
	 * Returns all distinct leave_type values actually present in your table. Useful
	 * for debugging — run this once to see what values your users entered.
	 */
