...
public class MeetingDao {
	...
	/**
	 * Get today's upcoming meetings for a manager (meetings they created)
	 */
	public static List<Meeting> getTodayMeetings(String manager) {
		List<Meeting> list = new ArrayList<>();
		String sql = "SELECT id, title, description, start_time, end_time, meeting_link " + 
				"FROM meetings " +
				"WHERE created_by = ? " + 
	...
	/**
	 * Get today's meetings for a manager (created by them)
	 */
	...
	/**
	 * Get today's meetings for an employee (meetings they are invited to)
	 * This includes meetings created by managers, admins, or anyone else
	 */
	...
	/**
	 * Get all upcoming meetings for an employee (for their meetings page)
	 */
	...
	/**
	 * Create a new meeting and return the generated meeting ID
	 */
	...
	/**
	 * Delete a meeting (cascade will delete participants automatically)
	 */
