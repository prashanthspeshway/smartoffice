...
public class TaskAttachmentServlet extends HttpServlet {
    ...
    /** Map a filename extension to its proper MIME type. */
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try (Connection con = DBConnectionUtil.getConnection();
            ...
            try (ResultSet rs = ps.executeQuery()) {
                ...
                // ── KEY CHANGE ──────────────────────────────────────────────
                // Use the real MIME type so the browser can render inline.
                // "inline" tells the browser to display, not download.
                // We still include the filename so the Download button works.
