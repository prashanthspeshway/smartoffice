...
public class ExportUsersServlet extends HttpServlet {
	...
	private static final String[] HEADERS = { "Username", "Email", "Role", "Status", "First Name", "Last Name",
			"Designation", "Joined Date", "Phone" };
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		String[][] summaryData = { { "Total Employees", String.valueOf(users.size()) },
				{ "Admins", String.valueOf(admins) }, { "Managers", String.valueOf(managers) },
				{ "Employees", String.valueOf(employees) }, { "Active", String.valueOf(active) },
